...
<head>
	...
	<title>Limitless - Products</title>
				...
				<div class="page-header">
					<div class="page-header-content d-sm-flex">
						<div class="page-title">
							<h4><span class="font-weight-semibold">Page Product</h4>
						</div>
					</div>
				</div>
				<!-- /page header -->
									...
									<div class="card-body">
										...
										if (isset($_POST['submit'])) {
											...
											if (!in_array($ext, $ekstensi)) {
												...
												if ($ukuran < 1044070) {
													$gambar_kaos = $rand . '_' . $filename;
													move_uploaded_file($_FILES['gambar']['tmp_name'], 'global_assets/' . $rand . '_' . $filename);
													mysqli_query($koneksi, "INSERT INTO products VALUES(NULL,'$judul_kaos','$gambar_kaos','','','','$kategori')");
										...
										<form action="" method="POST" enctype="multipart/form-data">
											<div class="form-group">
												<label>Judul Produk Kaos</label>
												<input type="text" name="judul" class="form-control" required>
											</div>
											<div class="form-group">
												<label>Gambar</label>
												<input type="file" name="gambar" class="input" required></i></input>
											</div>
											<div class="form">
										...
										<tbody>
											...
											?>
												<tr>
													<td><?= $no ?></td>
													<td><?= $data['id']; ?></td>
													<td><?= $data['judul_kaos']; ?></td>
													<td><img src="global_assets/<?= $data['gambar_kaos']; ?>" width="130" height="140"> </td>
													<td><?= $data['kategori']; ?></td>
												</tr>
												<?php $no++ ?>
											<?php } ?>
