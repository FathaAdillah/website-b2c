...
<head>
	...
	<title>Limitless - Testimoni</title>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-open nav-item-expanded">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Page layouts">
								...
								<li class="nav-item"><a href="testimoni.php" class="nav-link active">Testimoni</a></li>
								<li class="nav-item"><a href="portofolio.php" class="nav-link">Portofolio</a></li>
								...
								<div class="collapse show">
									<div class="card-body">
										...
										if (isset($_POST['submit'])) {
											...
											if (!in_array($ext, $ekstensi)) {
												...
												if ($ukuran < 1044070) {
													...
													move_uploaded_file($_FILES['foto']['tmp_name'], 'global_assets/testimoni/' . $rand . '_' . $filename);
													mysqli_query($koneksi, "INSERT INTO testimoni VALUES(NULL,'$nama','$foto','$instansi','$testimoni')");
										...
										<form action="" method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label>Foto</label>
												<input type="file" name="foto" class="input" required></i></input>
											</div>
											<div class="form">
												<label>Instansi</label>
												<input type="text" name="instasi" class="form-control" required>
											</div>
											<div class="form-group">
												<label>Caption Testimoni</label>
												<textarea class="form-control rounded-0" name="testimoni" rows="10"></textarea>
											</div>
											<br>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?= $data['id']; ?></td>
													<td><?= $data['nama']; ?></td>
													<td><img src="global_assets/testimoni/<?= $data['foto']; ?>" width="130" height="140"> </td>
													<td><?= $data['instasi']; ?></td>
													<td><?= substr($data['testimoni'], 0, 40) ?>...</td>
												</tr>
												<?php $no++ ?>
											<?php } ?>
										</tbody>
